...
namespace TraCuuThongTIn.DBContext
{
    ...
    public partial class tbThongTinCaNhan
    {
        ...
        public virtual tbXaPhuong Phuong { get; set; }
        public virtual tbQuanHuyen Quan { get; set; }
        public virtual tbTinhThanhPho ThanhPho { get; set; }
        public virtual tbTinhTrangHonNhan TinhTrangHonNhanNavigation { get; set; }
        public virtual tbNgheNghiep NgheNghiepNavigation { get; set; }
        public virtual tbNhomMau NhomMauNavigation { get; set; }
    }
}
